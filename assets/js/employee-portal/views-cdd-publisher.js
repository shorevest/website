...
(function (root) {
  ...
  function renderPack(f, output) {
    ...
    output.appendChild(el('div', { class: 'ops-panel' }, [
      ...
      el('p', { class: 'ops-lede', text: 'Next: save images to assets/images/cdd/, place the JSON in assets/data/, place the HTML at the site root, paste the archive snippet into /insights/, then open the PDF link and save as PDF.' })
    ]));
